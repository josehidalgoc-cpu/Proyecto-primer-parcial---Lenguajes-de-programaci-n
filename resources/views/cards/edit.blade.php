...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('cards.update', $card) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="card_number_encrypted" value="{{ old('card_number_encrypted', $card->card_number_encrypted) }}"
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="expiry_month" value="{{ old('expiry_month', $card->expiry_month) }}"
            ...
            <div>
                ...
                <input type="text" name="expiry_year" value="{{ old('expiry_year', $card->expiry_year) }}"
            ...
            <div>
                ...
                <input type="password" name="cvv_encrypted" value="{{ old('cvv_encrypted', $card->cvv_encrypted) }}"
