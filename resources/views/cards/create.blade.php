...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <form action="{{ route('cards.store') }}" method="POST" class="space-y-6" id="card-form">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="card_number_encrypted" id="card_number" value="{{ old('card_number_encrypted') }}"
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="expiry_month" id="expiry_month" value="{{ old('expiry_month') }}"
            ...
            <div>
                ...
                <input type="text" name="expiry_year" id="expiry_year" value="{{ old('expiry_year') }}"
            ...
            <div>
                ...
                <input type="text" name="cvv_encrypted" id="cvv" value="{{ old('cvv_encrypted') }}"
...
// Validar número de tarjeta al salir del campo
...
// Validar fecha de expiración al salir del campo
...
// Bloquear envío si hay errores visibles
